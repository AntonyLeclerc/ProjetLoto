...
model.add(tf.keras.layers.Conv2D(32, (3, 3), activation='relu', input_shape=(70,70,3)))
...
model.add(tf.keras.layers.Dense(51, activation='softmax'))  # Adjusted for 50 classes
...
#model = tf.keras.models.load_model("./noyau10x10_20epochs_images70x70_couleur_flip.h5")
...
desired_augmentation_size = 100000  # Specify the desired size of the augmented dataset
...
model.save("noyau10x10_10epochs_images70x70_couleur_flip_shift.h5")
...
plt.plot(range(1, nbEpochs+1), accs, color="blue", label="Accuracy")
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.title("Accuracy")
plt.legend()
